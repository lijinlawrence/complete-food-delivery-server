...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@demo-food-server.4scazax.mongodb.net/demo-food-server?retryWrites=true&w=majority&appName=demo-food-server`  
  )
